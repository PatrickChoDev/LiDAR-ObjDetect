...
#mayavi show point cloud
def visualize_np(pointcloud):
    ...
    mayavi.mlab.points3d(x, y, z,
                         ...
                         mode="point",
                         # Pseudo-color mapping of grayscale images
...
def main():
    ...
    plot3Dbox(corners)
    read_pointcloud_from_bin_file("./dataset/training/velodyne_reduced/007145.bin")
